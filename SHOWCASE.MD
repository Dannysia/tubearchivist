*These are upstream's screenshots and video, kept for reference. They
predate this fork's UI changes — there is no downscale queue, no import
file management and none of the added stats panels in them.*
